...
├── Logowhite.png          # Nimbus logo
├── Facebook.png           # Title slide background
├── rxinfer_logo.svg       # RxInfer logo
├── lazydynamics_logo.svg  # Lazy Dynamics logo
├── nimbus_engine.png      # Engine diagram
├── pipeline_builder.png   # Pipeline builder screenshot
├── Sergey.svg             # Team photos
├── Albert.svg
├── Kirill.svg
├── Dmitry.svg
├── Ismail_bw.png
├── Bart_bw.png
└── nimbus.mp4             # Thank you video
```
